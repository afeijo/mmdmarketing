 ...
 * @endcode
 */
$settings['hash_salt'] = 'qqetZtqwVkXp4aMV9W3Vu4lvjwlLKgcwEwNciX8R4PHQ7i2wX4E65kAigEL_wpZwzVMO5Vl9kg';
...
// filepath: /var/www/mary/dev/web/sites/default/settings.php
use Dotenv\Dotenv;

// Caminho para o arquivo .env (ajuste conforme necessário)
$dotenv = Dotenv::createImmutable(DRUPAL_ROOT . '/..');
$dotenv->load();

$databases['default']['default'] = array(
  'database' => getenv('MYSQL_NAME') ?: 'drupal10',
  'username' => getenv('MYSQL_USER') ?: 'drupal10',
  'password' => getenv('MYSQL_PASSWORD') ?: 'drupal10',
  'prefix' => '',
...
$settings['cache_prefix']['default'] = 'mmd';
